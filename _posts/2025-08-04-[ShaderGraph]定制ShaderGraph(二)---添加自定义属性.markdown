...
### 关于`SurfaceDescription`的来历

目前能查到的是`Library/PackageCache/com.unity.render-pipelines.universal@12.1.10/Editor/ShaderGraph/Includes/Varyings.hlsl`文件中的生成函数
...
然后在文件`Library/PackageCache/com.unity.shadergraph@12.1.10/Editor/Generation/Processors/Generator.cs`中
