...
- [High-End Lighting & Environments with HDRP in Unity 6 \| Unity](https://unity.com/resources/lighting-environments-hdrp-unity-6)
...
- [Working with physically based shading: A practical approach](https://unity.com/blog/engine-platform/practical-approach-to-physically-based-shading)
